...
export default function Home() {
  return (
    <div className="w-[1769px] h-[1151px] relative bg-gradient-to-b from-[#db4439] to-[#75241e] overflow-hidden">
      ...
      <div className="left-[891px] top-[46px] absolute justify-start text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">
        Me
      </div>
      <div className="right-[74px] top-[50px] absolute justify-start text-[#db4439] text-2xl font-bold font-['Inknut_Antiqua'] background-color-[#eaecd7]">
        Click
      </div>
      <div className="left-[516px] top-[46px] absolute justify-start text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">
        Login
      </div>
